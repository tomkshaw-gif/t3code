...
import {
  ...
  type PromoteQueuedThreadTurnInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    promoteQueuedTurn: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:promote-queued-turn",
      execute: (input: PromoteQueuedThreadTurnInput) => promoteQueuedThreadTurn(input),
      scheduler,
      concurrency,
    }),

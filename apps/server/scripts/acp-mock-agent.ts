...
// Publish a native slash-command catalog on session/new regardless of profile,
// for adapters that consume `available_commands_update` (Grok, Devin).
const advertiseCommands = process.env.T3_ACP_ADVERTISE_COMMANDS === "1";

...
export function ProviderIcon(props: ProviderIconProps) {
  ...
  if (props.provider === "devin") {
    // Official Devin chain-link mark (docs.devin.ai/logo/favicon.svg),
    // nominative use. Mono fill adapts to the theme like the other marks.
    return (
      <Svg width={size} height={size} viewBox="0 0 425 425" fill="none">
        <Path
          fill={mono}

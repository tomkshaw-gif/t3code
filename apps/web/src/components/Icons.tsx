...
// Devin chain-link mark, nominative use to identify the Devin provider.
// Upstream: official Devin docs favicon (https://docs.devin.ai/logo/favicon.svg),
// Cognition trademark. `fill` adapted to currentColor for themes.
